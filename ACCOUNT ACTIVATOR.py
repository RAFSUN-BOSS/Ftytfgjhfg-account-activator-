...
print("╚═╝╚═╝          ╚═╝  ╚═════╝ ╚═╝")
print(f"{RESET}")
print(f"{YELLOW}AC‑Activator | Account Activator{RESET}")
print(f"{BLUE}Maintained by Boss | Version 1{RESET}\n")

# Loading bar
def loading_bar(msg):
    print(f"{CYAN}{msg} ", end="")
    for i in range(101):
        print(f"\r{CYAN}{msg} {i}%", end="")
        time.sleep(0.01)
    print(f" ✔{RESET}\n")

loading_bar("Initializing AC‑Activator")
